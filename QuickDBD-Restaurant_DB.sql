...
-- Link to schema: https://app.quickdatabasediagrams.com/?code=b216f9f09e98b55a45a5#/d/o9cvgA
...
CREATE TABLE `recipe` (
    `row_id` int  NOT NULL ,
    `receipe_id` varchar(20)  NOT NULL ,
...
CREATE TABLE `staff` (
    ...
    `hourky_rate` decimal(5,2)  NOT NULL ,
    PRIMARY KEY (
        `staff_id`
    )
);
...
ALTER TABLE `recipe` ADD CONSTRAINT `fk_recipe_receipe_id` FOREIGN KEY(`receipe_id`)
REFERENCES `item` (`sku`);
